...
LuigiSMP je **forever world** — server, co se nikdy neresetuje, vyvíjený jedním člověkem s láskou k detailu. Kromě klasického přežívání tu najdeš spoustu vlastních systémů: hlubinný mining gamemode, chunk-based claimy na ochranu stavby, systémovou poštu s odměnami, a různé drobnosti co v čisté vanille nenajdeš.
...
- ⛏️ **Zajímá tě hlavní gamemode?** → [Rock Bottom — důl](rock-bottom/zaklady.md)
